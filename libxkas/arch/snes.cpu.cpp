...
bool xkasSNESCPU::assemble_command(string &s) {
  ...
  if(part[1].wildcard("*,s")) {
    part[1].rtrim<1>(",s");
    force_test();
    if(assemble_sr()) return true;
    return false;
  }

  if(part[1].wildcard("(*,s),y")) {
    part[1].ltrim<1>("(");
    part[1].rtrim<1>(",s),y");
    force_test();
    if(assemble_sry()) return true;
    return false;
  }
  ...
  if(part[1].wildcard("[*],y")) {
    ...
    part[1].rtrim<1>("],y");
    force_test();
    if(assemble_indirect_long_y()) return true;
    return false;
  }
  ...
  if(part[1].wildcard("[*]")) {
    ...
    part[1].rtrim<1>("]");
    force_test();
    if(assemble_indirect_long()) return true;
    return false;
  }
  ...
  if(part[1].wildcard("*,x")) {
    part[1].rtrim<1>(",x");
    force_test();
    if(assemble_long_x()) return true;
